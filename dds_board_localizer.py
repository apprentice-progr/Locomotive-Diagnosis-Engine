...
ECODE_BOARD_MAP: Dict[str, dict] = {
    ...
    "5091": {"board_id": "SPIF_FIRE",  "description": "Fire detection input / STB2 cubicle",
             ...
             "confidence": 0.88},
    # Speedometer failed — ECode 508F, confirmed IRPRP43570
    "508F": {"board_id": "SPIF_SPEEDO", "description": "Speedometer signal input / SPIF",
             "part_ref": "speed sensor", "replaces": "Speed sensor wiring at axle box — not a card fault first",
             "confidence": 0.85},
